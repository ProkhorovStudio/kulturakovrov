...
$APPLICATION->SetPageProperty("description", "Магазин премиум класса KULTURAKOVROV предлагает широкий выбор элитных натуральных ковров ручной работы в Москве. У нас вы можете купить как готовый ковер, так и заказать изготовление ковра по индивидуальному эскизу. Услуга бесплатной примерки, более 15 тыс. уникальных моделей, 100% гарантия возврата средств.");
$APPLICATION->SetPageProperty("title", "Салон ковров ручной работы премиум класса KULTURAKOVROV в Москве");
...
<?/*$APPLICATION->IncludeComponent(
	...
	[
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "slider-home-new",
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "Y",
		"DISPLAY_DATE" => "Y",
		"DISPLAY_NAME" => "Y",
