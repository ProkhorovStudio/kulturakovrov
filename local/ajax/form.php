...
if($name && $phone){
    sendCrm($phone,$name,$idRois,$titleCover,$artikleCover,$type);
}
...
function sendCrm($phone, $name,$idRois,$titleCover,$artikleCover,$type){
    $roistatData = array(
        'roistat' => $idRois,
        ...
        'title'   => 'Заявка с сайта('.$type.')', // Название сделки
