...
$APPLICATION->AddHeadString("<meta http-equiv='Content-Security-Policy' content='script-src 'self' 'unsafe-inline' bitrix.local'>");


?>

<script asunc src="<?=$templateFolder?>/script.js"></script>
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="left-view-block">
                ...
                <div class="dots-other-images">
                    <?foreach ($mobilePhotos as $image):?>
                        <div class="dots-other__item">
                            <img src="<?=$image?>" alt="<?=$name?>">
                        </div>
                    <?endforeach?>
                </div>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="right-view-block">
                <a href="<?=$arResult['DETAIL_PAGE_URL']?>" class="btn-more-view">Полная карточка</a>
                ...
                <div class="card-product">
                    ...
                    <div class="price-block">
                        ...
                        <?endif?>
                        <div class="row">
                            <div class="col-md-6"> <div class="price-block__price" id="<?=$itemIds['PRICE_ID']?>">
                                    <?if($visiblePrice):?>
                    ...
                    <div class="manager-block">
                        ...
                        <div class="manager-block__description">
                            ...
                            <div class="manager-block__description-info">
                                ...
                                <span class="time-work">(10:00-20:00 ПН-ПТ)</span>
                            </div>
                            <div class="manager-block__description-buttons">
                                <span artikle="<?=$artikles[0]?>" title="<?=$nameModal?>" data-call="" data-counter="form_5">Перезвоните мне</span>
                                <a class="tg-chat" href="http:\\yandex.ru" target="_blank">Чат в телеграм</a>
...
CJSCore::Init(['ajax', 'fx', 'popup', 'ui.buttons', 'ui.icons']);

// Скрипт корзины (актуально для Битрикс 20+)
$APPLICATION->AddHeadScript('/bitrix/js/main/core/core_ajax.js');
$APPLICATION->AddHeadScript('/bitrix/js/ui/buttons/buttons.min.js');
$APPLICATION->AddHeadScript('/bitrix/js/sale/core.js');
$APPLICATION->AddHeadScript('/bitrix/js/sale/basket.js'); // Главный скрипт!