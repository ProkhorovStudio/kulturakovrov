...
<?// ******************** /User properties ***************************************************
    ...
    <label for="lisense-auth">
        <input id="lisense-auth" required="" type="checkbox" value="Y" name="lisense">
        <span>Нажимая на кнопку "Регистрация", я даю <a target="_blank" href="/soglasie-na-obrabotku-pd/">согласие на обработку моих персональных данных</a>, в соответствии с <a target="_blank" href="/politika-pd/">политикой</a> и принимаю <a target="_blank" href="/oferta/">условия оферты</a></span>
    </label>
</form>
