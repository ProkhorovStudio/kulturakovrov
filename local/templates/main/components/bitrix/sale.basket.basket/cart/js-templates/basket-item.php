			...
			<td class="basket-items-list-item-notification" colspan="<?=$restoreColSpan?>">
				<div class="basket-items-list-item-notification-inner basket-items-list-item-notification-removed" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-items-list-item-removed-container">
						<div>
							<?=Loc::getMessage('SBB_GOOD_CAP')?> {{NAME}} <?=Loc::getMessage('SBB_BASKET_ITEM_DELETED')?>.
						</div>
															...
															<ul class="basket-item-scu-list">
																{{#SKU_VALUES_LIST}}
																	<li class="basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
																		...
																		data-sku-name="{{NAME}}"
																		data-property="{{PROP_CODE}}">
																		<span class="basket-item-scu-item-inner">{{NAME}} см</span>
																	</li>
																{{/SKU_VALUES_LIST}}
															</ul>
														</div>
					...
					<div class="basket-item-amount-field-description">
						...
						else
						{
							...
							{{#SHOW_PRICE_FOR}}
								...
								<span id="basket-item-price-{{ID}}">{{{PRICE_FORMATED}}} /шт</span>
							{{/SHOW_PRICE_FOR}}
							{{^SHOW_PRICE_FOR}}
								{{MEASURE_TEXT}}
							{{/SHOW_PRICE_FOR}}
