    ...
    foreach($arResult["ITEMS"] as $arItem):?>
        ...
        <div class="col-lg-6" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div class="item-services item-<?=$i?>">
                ...
                <div type="Услуга <?=$arItem['NAME']?>" class="btn-more" data-call="<?=$arItem['PROPERTIES']['ATT_TEXT_MODAL']['VALUE']?>" data-counter="form-<?=$i?>"  ><?=$arItem['PROPERTIES']['ATT_TEXT_BTN']['VALUE']?></div>
            </div>
        </div>
    <?endforeach;?>
</div>
