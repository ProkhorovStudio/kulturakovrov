...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data" onsubmit="ym(100102212,'reachGoal','order');">
		<?
		...
		<div id="bx-soa-order" class="row orderform--v1 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-total-mobile" style="margin-bottom: 6px;" class="d-md-block d-lg-none"></div>
