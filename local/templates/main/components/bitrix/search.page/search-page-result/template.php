...
$GLOBALS['APPLICATION']->SetPageProperty('canonical', 'https://kulturakovrov.ru/search/');
?>
...
<?endif;?>
	...
	&nbsp;<input class="search-page-button" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<a class="result-search-item" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>

	<?endforeach;?>

<?else:?>
	<p class="not-found-text">Сожалеем, но ничего не найдено.</p>
<?endif;?>
</div>